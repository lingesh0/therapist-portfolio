  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        'dm-sans': ['DM Sans', 'Inter', 'ui-sans-serif', 'system-ui', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Helvetica Neue', 'Arial', 'Noto Sans', 'sans-serif'],
      },
      fontSize: {
      ...
      backgroundImage: {
        ...
        'gradient-hero': 'linear-gradient(135deg, #f0fdfa 0%, #e0f2fe 50%, #f0f9ff 100%)',
      },
    },
  },
  plugins: [],
